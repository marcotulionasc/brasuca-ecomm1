...
function cartComponent() {
    return {
        ...
        /**
         * Função opcional para remover um ingresso do carrinho
         * @param {number} idIngresso - ID do ingresso a ser removido
         */
        /*
        removeItem(idIngresso) {
            // Implementar a lógica de remoção se necessário
            this.cartItems = this.cartItems.filter(item => item.idIngresso !== idIngresso);
        }
        */
    }
}